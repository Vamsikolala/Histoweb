...
import { ArrowLeft, Activity, Search, ChevronRight } from 'lucide-react';

export const GISTSelector: React.FC = () => {
  ...
  const options = [
    {
      ...
      path: `/patient/${id}/modules/git/gist/ki67`
    },
    {
      title: 'KIT',
      subtitle: 'CD117 Marker Analysis',
      icon: <Search size={20} color="var(--color-primary)" />,
      path: `/patient/${id}/modules/git/gist/kit`
    }
  ];

  return (
    <Layout title="GIT - GIST">
