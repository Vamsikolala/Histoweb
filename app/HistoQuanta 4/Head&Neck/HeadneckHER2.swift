...
struct HeadneckHER2: View {
    ...
    @State private var selectedResult = "0 negative"
    ...
    var inference: String {
        if selectedResult == "3+ positive" { return "Positive" }
        if selectedResult == "2+ equivocal" { return "Equivocal" }
        return "Negative"
    }
    ...
    func saveAnalysis() {
        ...
        let notesText = "Selection: \(selectedResult)"
        _ = diagnosisText
        _ = notesText
        let fullReport = """
