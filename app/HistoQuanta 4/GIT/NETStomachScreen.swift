...
struct NETStomachScreen: View {
    ...
    @State private var selectedRange = "0-2%"
    ...
    let rangeOptions = ["0-2%", "3-20%", "21-55%", ">55%"]

    var grading: String {
        switch selectedRange {
        case "0-2%": return "Grade 1 (G1)"
        case "3-20%": return "Grade 2 (G2)"
        case "21-55%": return "Grade 3 (G3)"
        case ">55%": return "High grade"
        default: return ""
        }
    }
    ...
    var resultText: String {
        switch selectedRange {
        case "0-2%": return "Well-differentiated neuroendocrine tumor — Grade 1 (G1)"
        case "3-20%": return "Well-differentiated neuroendocrine tumor — Grade 2 (G2)"
        case "21-55%": return "Well-differentiated neuroendocrine tumor — Grade 3 (G3)"
        case ">55%": return "Poorly-differentiated neuroendocrine carcinoma (NEC) — High grade"
        default: return ""
        }
    }
    ...
    var resultColor: Color {
        ...
        case "21-55%": return .red
        case ">55%": return Color(red: 0.5, green: 0.4, blue: 0.9) // Purple-ish blue
        default: return .gray
        }
    }
    ...
    var body: some View {
        ZStack {
            VStack(spacing: 0) {
                StandardHeader(title: "NET Stomach") {
                    Button(action: { navManager.navigate(to: .gitNETGuidelines) }) {
                        ZStack {
                            Circle()
                    ...
                    VStack(spacing: 24) {
                        ...
                        .overlay(
                            RoundedRectangle(cornerRadius: 22)
                                .stroke(resultColor.opacity(0.2), lineWidth: 2)
                        )
    ...
    var inferenceCard: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            VStack(alignment: .leading, spacing: 10) {
                inferenceRow(text: "0-2% → Grade 1 (G1)", color: .green)
                inferenceRow(text: "3-20% → Grade 2 (G2)", color: .orange)
                inferenceRow(text: "21-55% → Grade 3 (G3)", color: .red)
                inferenceRow(text: "> 55% → High grade (NEC)", color: Color(red: 0.5, green: 0.4, blue: 0.9))
            }
        }
        .frame(maxWidth: .infinity, alignment: .leading)
        .padding(18)
    ...
    func saveAnalysis() {
        ...
        let fullReport = """
        CLINICAL ANALYSIS REPORT: STOMACH NET GRADING
        -------------------------------------------
...
struct NETStomachScreen_Previews: PreviewProvider {
