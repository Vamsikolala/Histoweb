...
export const AdenocarcinomaSurgical: React.FC = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const fullReport = `CLINICAL ANALYSIS REPORT: ADENOCARCINOMA HER2 (SURGICAL)
-------------------------------------------
...
Conclusion: ${resultText}`;
      ...
      const response = await fetch('/add_analysis_report.php', {
        ...
        body: new URLSearchParams({
          ...
          tissue_type: "GIT",
          marker: "Adenocarcinoma Surgical",
    ...
    <Layout title="GIT Analysis">
      ...
      <div style={{ 
        ...
        <div style={{ padding: '10px 18px 24px', textAlign: 'center' }}>
          ...
          <div style={{ fontSize: '16px', color: '#6b7280' }}>HER2 - Surgical Specimen</div>
        </div>
        ...
        <div style={{ margin: '0 18px 24px', padding: '20px', backgroundColor: '#fff', borderRadius: '18px', boxShadow: '0 3px 8px rgba(0,0,0,0.05)' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '15px' }}>
            ...
            <button 
              onClick={() => navigate(`/patient/${id}/modules/git/git-guidelines-surgical`)}
              style={{
                padding: '6px 12px',
                backgroundColor: '#fff',
