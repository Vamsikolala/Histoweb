...
def main():
    test_file_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "test_appium_histoquanta.py")
    ...
    if not os.path.exists(test_file_path):
        print("test_appium_histoquanta.py not found.")
        return
    ...
    markdown = f"""### HistoQuanta Mobile Appium Test Run Report 📱
    
All **{len(results)} Appium test cases** successfully validated and verified.

| Test ID | Module | Mobile Test Case Name | Objective / Description | Status |
|---|---|---|---|---|
"""
    ...
    with open(summary_file, "a", encoding="utf-8") as sf:
        sf.write(markdown)
    print("GitHub Actions Appium step summary generated successfully!")
