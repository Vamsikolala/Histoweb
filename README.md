...
└── automated-tests/  → Selenium automated testing suite (Node.js)
```
...
### 5. Automated Tests (Selenium)

To run the automated test suite and check application features:
...
For config options and reports viewing, see [automated-tests/README.md](file:///Users/saill1/Downloads/Histoquanta%202/automated-tests/README.md).
